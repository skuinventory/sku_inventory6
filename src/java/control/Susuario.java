...
public class Susuario extends HttpServlet {
    ...
    protected void registrarapre (HttpServletRequest request, HttpServletResponse response)
        ...
        PrintWriter out = response.getWriter();
            ...
            n=request.getParameter("usuarop");
            a=request.getParameter("password");
            
            

            UsuarioGS cli=new UsuarioGS(d, n, a);
            Gestionusuario gc=new Gestionusuario();
            x=gc.insertusuario(cli);
            if(x){
                JOptionPane.showMessageDialog(null, "usuario agregado");
            }
            else{
                JOptionPane.showMessageDialog(null, "usuario no agregados");
            }
