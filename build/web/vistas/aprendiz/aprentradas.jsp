...
<html>
    <head>
        ...
        <title>Sku Inventory-Aprendiz-Entrada</title>
    ...
    <body>
        ...
        <div class="contenido">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form>
                                ...
                                <label>Unidades adquieridas: </label><br>
                                <input type="number"><br><br>
                                
                                <label>Costo de Mercancia: </label><br>
                                <input type="number"><br><br>
                                
                                
                                <label>Fletes: </label><br>
                                <input type="text"><br><br>
                                
                                
                                <input type="button" value="Registrar Entrada">
                            </form>
                        </div>
                    </div>
                </div>
            ...
            <table class="table">
                ...
                <th>FECHA</th>
                <th>DESCRIPCION</th>
                <th>UNIDAD ADQUIRIDA</th>
                <th>COSTO MERCANCIA</th>
                <th>DESCUENTO</th>
                <th>FLETES</th>
