        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-8 cont-formulario">
                    ...
                    <h2><strong>REGISTRO APRENDIZ</strong></h2>
                    <%
                        String documento;
                    ...
                    <form action="../../Saprendiz" method="POST" class="cont-form">
                        ...
                        <input type="text" name="ficha" pattern="[0-9]+" required><br><br>
                        ...
                        <input type="submit" name="registrara" value="Registrar">
                    </form>       
                </div>
            </div>
        </div>
